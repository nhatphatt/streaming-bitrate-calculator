...
This guide covers the optimal OBS recording settings for every use case in 2026. If you also need stream bitrate, encoder, and platform settings, start with the [OBS settings hub](/obs/).
...
This produces excellent quality at reasonable file sizes. A 1-hour 1080p 60fps recording at CQP 20 is typically 3–5 GB with HEVC. Use the [Recording Time Calculator](/tools/recording-time-calculator/) to estimate how many hours fit on your drive.
